...
cells_keep = c("_T$", "_EC$", "_Mono$","_MDMs$", "_KCs$","_Mph$", "_DCs$","_Hep")
...
save = F
if(save == TRUE){
  saveRDS(multinichenet_output, paste0(path, "multiContrast_RNA_MTEcHep.rds"))
}
```
...
ggsave("multiniche_output/multicontrast/output/pretumor_top_LR.pdf", plot_oi, width = 20, height = 30, dpi = 300)
...
ggsave("multiniche_output/multicontrast/output/tumor_top_LR.pdf", plot_oi, width = 20, height = 30, dpi = 300)
```
...
for (receiver_oi in cell_list) {
  ...
  file_name = paste0("multiniche_output/multicontrast/output/",group_oi,"_receivers/",group_oi,"_top_70_", receiver_oi, "_receivers.pdf")
...
for (sender_oi in cell_list) {
  ...
  file_name <- paste0("multiniche_output/multicontrast/output/",group_oi,"_senders/",group_oi,"_top_70_", sender_oi, "_senders.pdf")
  ggsave(file_name, plot_oi, width = 15, height = 10, dpi = 300)
}
```
...
for (receiver_oi in cell_list) {
  ...
  tryCatch({
    ...
    file_name = paste0("multiniche_output/multicontrast/output/",group_oi,"_ligand_receiver", receiver_oi, "_ligand_target_bars.pdf")
...
for (receiver_oi in cell_list) {
  ...
  tryCatch({
    ...
    # Save the plot to a PDF file with the receiver's name
    file_name = paste0("multiniche_output/multicontrast/output/correlationplot/", receiver_oi, "_",group_oi,"_ligand_target_correlation.pdf")
...
ggsave("multiniche_output/multicontrast/output/Pretumor_intercellular_regulatory_network.pdf", network_graph$plot, width = 18, height = 13,dpi = 300)
```
...
plot_oi = make_ligand_activity_plots(
  ...
  widths = NULL)
plot_oi
ggsave("multiniche_output/multicontrast/output/ligand_activity_plots.pdf", plot_oi, width = 30, height = 16, dpi = 300)
```
...
```{r}
network$links %>% head()
network$links %>% filter(sender_ligand == "Maf_CD4_T_Fgf2" & direction_regulation == "up" & group == "pretumor")
