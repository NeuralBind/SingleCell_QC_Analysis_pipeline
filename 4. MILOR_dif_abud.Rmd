...
```{r}
write.csv(da_results_ctl_int, "da_ctlvsint.csv", row.names = FALSE)
write.csv(da_results_int_end, "da_endvsint.csv", row.names = FALSE)
write.csv(da_results_ctl_end, "da_ctlvsend.csv", row.names = FALSE)
...
```{r}
ggsave("intVSctl.pdf", plot = p1, width = 8, height = 6, dpi = 300)
p1
```

```{r}
ggsave("intVSend.pdf", plot = p2, width = 8, height = 6, dpi = 300)
...
```{r}
ggsave("endVSctl.pdf", plot = p3, width = 8, height = 6, dpi = 300)
p3
```
...
ggsave("intVSctl_beeswarm.pdf", plot = bee1, width = 7, height = 5, dpi = 300)
bee2 <- plotDAbeeswarm(da_results_int_end, group.by = "cell_type", alpha = 1)+ggtitle("Intermediate vs End")
ggsave("intVSend_beeswarm.pdf", plot = bee2, width = 7, height = 5, dpi = 300)
bee3 <- plotDAbeeswarm(da_results_ctl_end, group.by = "cell_type", alpha = 1)+ggtitle("End vs Control")
ggsave("endVSctl_beeswarm.pdf", plot = bee3, width = 7, height = 5, dpi = 300)
```
```{r}
bee1
bee2
